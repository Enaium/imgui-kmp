...
include(":examples:docking")
include(":examples:docking:android")
include(":examples:image")
include(":examples:image:android")
...
include(":examples:font")
include(":examples:markdown")
include(":examples:markdown:android")
